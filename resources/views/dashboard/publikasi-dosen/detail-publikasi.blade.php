                            ...
                            <div class="w-full md:w-1/2 space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="kontributor" id="kontributor"
                                        ...
                                        placeholder="Masukkan kontributor dalam publikasi" value="Penulis Tunggal" required disabled/>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="jenis" id="jenis"
                                        class="bg-gray-100 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-[#48A6A7] focus:border-[#48A6A7] block w-full p-2.5"
                                        placeholder="Masukkan jenis publikasi" value="Jurnal SINTA Ristek Dikti" required disabled />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="tahun" id="tahun"
                                        class="bg-gray-100 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-[#48A6A7] focus:border-[#48A6A7] block w-full p-2.5"
                                        value="2025" placeholder="Masukkan tahun publikasi" min="2000" max="2025" required disabled />
                                </div>
                            ...
                            <div class="w-full md:w-1/2 space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="judul" id="judul"
                                        ...
                                        placeholder="Masukkan judul publikasi" required disabled>The Integration of Popular Culture in Islamic Dakwah for Gen Z; The Case Study of Ustadz Hanan Attaki and Ustadzah Oki Setiana Dewi’s Dakwah</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="penerbit" id="penerbit"
                                        class="bg-gray-100 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-[#48A6A7] focus:border-[#48A6A7] block w-full p-2.5"
                                        placeholder="Masukkan penerbit dari publikasi" value="UIN Maulana Malik Ibrahim Malang" required
                                        disabled />
                                </div>
                            </div>
                        </div>
