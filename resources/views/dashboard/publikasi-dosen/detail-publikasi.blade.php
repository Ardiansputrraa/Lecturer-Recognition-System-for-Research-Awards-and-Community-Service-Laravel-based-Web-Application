...
<script>
    function ubahPublikasi(id) {
        ...
        if (kontributor == "" || judul == "" || tahun == "" || jenis == "" || penerbit == "") {
            Swal.fire({
                title: "Info",
        ...
        $.ajax({
            ...
            success: function(response) {
                Swal.fire({
                    title: "Berhasil",
                    text: "Data publikasi berhasil diubah!",
                    icon: "success",
                    confirmButtonText: "Oke",
                }).then(() => {
                    window.location.reload();
    ...
    function uploadFilePublikasi(publikasi_id) {
        ...
        formSumberDaya.append('publikasi_id', publikasi_id);
        formSumberDaya.append('file', file);

        $.ajax({
            type: "POST",
            url: "{{ route('upload.file.publikasi') }}",
            data: formSumberDaya,
            contentType: false,
            processData: false,
            success: function(response) {
                Swal.fire({
                    title: "Berhasil",
                    text: "Bukti publikasi berhasil diunggah!",
                    icon: "success",
                    confirmButtonText: "Oke",
                }).then(() => {
                    window.location.reload();
    ...
    function hapusFilePublikasi(file_id) {
        $.ajax({
            type: "GET",
            url: `/delete-file-publikasi/${file_id}`,
            data: {
                _token: "{{ csrf_token() }}"
            },
            success: function(response) {
                Swal.fire({
                    title: "Berhasil",
                    text: "Bukti publikasi berhasil dihapus!",
                    icon: "success",
                    confirmButtonText: "Oke",
                }).then((result) => {
...
<body class="bg-gray-100" x-data="{ sidebarOpen: false }">
        ...
        <div class="flex flex-col lg:flex-row gap-4 w-full h-[700px]">
            ...
            <div class="bg-white w-full lg:w-[70%] p-6 shadow rounded overflow-y-auto h-full">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-y-3 mb-4">
                    ...
                    <div class="flex gap-4">
                        <h1 class="text-md py-1 font-semibold text-gray-900">Status Publikasi</h1>
                    ...
                    <form class="space-y-4" action="#">
                        <div class="flex flex-col md:flex-row gap-4">
                            <div class="w-full md:w-1/2 space-y-4">
                                <!-- kontributor -->
                                <div>
                                    <label for="kontributor"
                                        class="block mb-2 text-sm font-medium text-gray-900">Kontributor
                                        Publikasi</label>
                                    <input type="text" name="kontributor" id="kontributor"
                                        ...
                                        placeholder="Masukkan kontributor dalam publikasi"
                                        value="{{ $publikasi->kontributor }}" required disabled />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="jenis" id="jenis"
                                        class="bg-gray-100 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-[#48A6A7] focus:border-[#48A6A7] block w-full p-2.5"
                                        placeholder="Masukkan jenis publikasi" value="{{ $publikasi->jenis }}" required
                                        disabled />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="tahun" id="tahun"
                                        class="bg-gray-100 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-[#48A6A7] focus:border-[#48A6A7] block w-full p-2.5"
                                        value="{{ $publikasi->tahun }}" placeholder="Masukkan tahun publikasi"
                            ...
                            <div class="w-full md:w-1/2 space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="judul" id="judul"
                                        ...
                                        placeholder="Masukkan judul publikasi" required disabled>{{ $publikasi->judul }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="penerbit" id="penerbit"
                                        class="bg-gray-100 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-[#48A6A7] focus:border-[#48A6A7] block w-full p-2.5"
                                        placeholder="Masukkan penerbit dari publikasi"
                                        value="{{ $publikasi->penerbit }}" required disabled />
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="mt-12 border-t-2 border-gray-300">
                    <div class="flex items-center justify-between mb-4 mt-6">
                        <h1 class="text-xl font-semibold text-gray-900">Bukti Publikasi</h1>
                        @if (Auth::user()->role == 'dosen')
                            <!-- Tombol Edit Publikasi -->
                            <button data-modal-target="uploadBuktiPublikasiModal"
                                data-modal-toggle="uploadBuktiPublikasiModal" type="button"
                                class="flex items-center gap-2 text-[#48A6A7] px-4 py-2 hover:text-[#006A71] transition duration-300 w-full md:w-auto hover:underline">
                                <!-- Icon Edit (Pencil) -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20"
                                    fill="currentColor">
                    ...
                    <div class="mt-4 space-y-5">
                        <p class="text-sm text-gray-500">Unggah bukti publikasi yang telah dilakukan. Pastikan file
                            yang
                                ...
                                @foreach ($filePublikasi as $file)
                                    @php
                                        ...
                                        if ($file->tipe == 'pdf') {
                                            ...
                                            $icon = 'https://cdn-icons-png.flaticon.com/512/337/337950.png';
                                            $tipe = 'Gambar';
                                        } else {
                                    ...
                                    <div
                                        ...
                                        <div class="flex gap-4">
                                            {{-- Tombol Hapus --}}
                                            <button type="button" onclick="hapusFilePublikasi('{{ $file->id }}')"
                                            ...
                                            {{-- Tombol Download --}}
                                            <a href="{{ route('download.file.publikasi', $file->id) }}"
                                                class="relative group flex items-center justify-center w-10 h-10">
                        ...
                        @if (Auth::user()->role == 'dosen')
                            <div class="flex justify-end">
                                <div class="flex items-center justify-between gap-4 mt-4 mb-4">
                                    <button type="button" onclick="ubahPublikasi('{{ $publikasi->id }}')"
            ...
            <div class="w-full lg:w-[30%] flex flex-col gap-4 h-full">
                <div class="bg-white w-full p-4 shadow rounded overflow-y-auto h-[50%]">
                        ...
                        <div class="relative group">
                            ...
                            <div id="dropdownKomentar"
                                ...
                                <form action="#" method="POST" class="space-y-3">
                                    ...
                                    <button type="button" onclick="addKomentar('{{ $publikasi->id }}')"
                                ...
                                <script>
                                    function addKomentar(publikasi_id) {
                                        ...
                                        $.ajax({
                                            url: "{{ route('add.komentar.publikasi') }}",
                                            type: 'POST',
                                            data: {
                    ...
                    <div class="space-y-2">
                        @if ($komentarPublikasi->isEmpty())
                            <div class="text-center text-gray-500 font-medium p-4">
                                Belum ada komentar.
                            </div>
                        @else
                            @foreach ($komentarPublikasi as $data)
                        ...
                        <script>
                            function deleteKomentar(komentar_id) {
                                $.ajax({
                                    url: `/delete-komentar-publikasi/${komentar_id}`,
                                    type: 'GET',
                                    data: {
                                        _token: '{{ csrf_token() }}'
                                    },
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="relative group">
                            ...
                            <div id="dropdownKolaborasi"
                                ...
                                @foreach ($dosen as $data)
                                    <div class="flex items-center gap-4 w-full p-4 bg-gray-100 rounded-lg shadow-lg">
                                        ...
                                        <div class="flex justify-between w-full items-center">
                                            ...
                                            @if (Auth::user()->role == 'dosen')
                                                <button type="button"
                                                    onclick="addKolaborasi('{{ $data->id }}', '{{ $publikasi->id }}')"
                                ...
                                <script>
                                    function addKolaborasi(dosen_id, publikasi_id) {

                                        $.ajax({
                                            url: "{{ route('add.kolaborasi.publikasi') }}",
                                            type: 'POST',
                                            data: {
                                                dosen_id: dosen_id,
                                                publikasi_id: publikasi_id,
                                    ...
                                    function deleteKolaborasi(kolaborasi_id) {
                                        $.ajax({
                                            url: `/delete-kolaborasi-publikasi/${kolaborasi_id}`,
                                            type: 'GET',
                                            data: {
                                                _token: '{{ csrf_token() }}'
                                            },
    ...
    <!--Modal Unggah Bukti Publikasi-->
    <div id="uploadBuktiPublikasiModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow-lg">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="uploadBuktiPublikasiModal">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b gap-4">
                    <button type="button" onclick="uploadFilePublikasi('{{ $publikasi->id }}')"
                    ...
                    <button data-modal-hide="uploadBuktiPublikasiModal"
                        class="bg-[#EF4444] border-2 border-[#DC2626] hover:bg-white text-white hover:text-[#DC2626] font-medium py-2 px-4 rounded-lg transition duration-300">
                        Batal
                    </button>
                </div>
