    ...
    <main :class="sidebarOpen ? 'sm:ml-64' : 'sm:ml-16'"
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mt-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 mt-4">
                ...
                <button data-modal-target="tambahPublikasiModal" data-modal-toggle="tambahPublikasiModal" type="button"
                ...
                <div class="flex flex-row  items-stretch sm:items-center gap-4 w-full md:w-auto">
                    ...
                    <div class="relative w-full sm:w-64">
                        <input type="text" placeholder="Cari Publikasi Dosen"
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-12">
                ...
                <div class="w-full max-w-xs">
                    <select id="tahunPublikasi" name="tahunPublikasi"
                ...
                <table class="w-full text-sm text-left text-gray-700">
                    ...
                    <tbody>
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-4 py-3">Penulis Tunggal</td>
                            <td class="px-4 py-3">Investigating Unequal Englishes Understanding, Researching and
                                Analysing Inequalities of the Englishes of the World</td>
                            <td class="px-4 py-3">Jurnal SINTA Ristek Dikti</td>
