        ...
        <div class="flex flex-col lg:flex-row gap-4 w-full h-[700px]">
            ...
            <div class="bg-white w-full lg:w-[70%] p-6 shadow rounded overflow-y-auto h-full">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button data-modal-target="uploadBuktiPenelitianModal" data-modal-toggle="uploadBuktiPenelitianModal"
                        type="button"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-lg">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
                    <button data-modal-hide="uploadBuktiPenelitianModal" type="button"
                        ...
                        Unggah Bukti Penelitian</button>
                    <button data-modal-hide="uploadBuktiPenelitianModal" type="button"
